...
const services = [
	{
		...
		description:
			'High-performing websites and online stores with custom designs and reliable hosting.',
		icon: Monitor,
	...
	},
	{
		...
		description:
			'Grow your brand with targeted content and partnerships.',
		icon: Share2,
			...
			<div className='max-w-7xl mx-auto'>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
					{services.map((service, index) => (
						<div
							key={index}
							className='group relative bg-[#011420] rounded-2xl p-8 
						...
						>
                            ...
                            text-gray-400 group-hover:text-[#00EA6F] 
